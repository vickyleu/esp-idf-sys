...
// Old PCNT API (deprecated, ESP-IDF < 6, not for ESP32-P4)
#if defined(CONFIG_IDF_TARGET_ESP32) || defined(CONFIG_IDF_TARGET_ESP32S2) || defined(CONFIG_IDF_TARGET_ESP32S3) || defined(CONFIG_IDF_TARGET_ESP32H2) || defined(CONFIG_IDF_TARGET_ESP32C5) || defined(CONFIG_IDF_TARGET_ESP32C6)
#if ESP_IDF_VERSION_MAJOR < 6
#include "driver/pcnt.h"
#endif
#endif
// New PCNT API (pulse_cnt.h, ESP-IDF >= 5, includes ESP32-P4)
